...
SELECT ROW_NUMBER() OVER (ORDER BY (SELECT NULL)) AS "source_row_number",
       ...
       TRY_TO_TIMESTAMP_NTZ(TO_VARCHAR("DATE_REQUESTED"))::TIMESTAMP_NTZ AS "date_requested",
       ...
       TRY_TO_TIMESTAMP_NTZ(TO_VARCHAR("APPROVAL_DATE"))::TIMESTAMP_NTZ AS "approval_date",
