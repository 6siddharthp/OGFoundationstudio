...
SELECT ROW_NUMBER() OVER (ORDER BY (SELECT NULL)) AS "source_row_number",
       ...
       "QA_APPROVER_ID"::VARCHAR AS "reviewer_id",
       COALESCE(TRY_TO_TIMESTAMP_NTZ("DATE_REQUESTED", 'MM/DD/YYYY'), TRY_TO_TIMESTAMP_NTZ("DATE_REQUESTED"))::TIMESTAMP_NTZ AS "date_requested",
       COALESCE(TRY_TO_TIMESTAMP_NTZ("DATE_RECEIVED", 'MM/DD/YYYY'), TRY_TO_TIMESTAMP_NTZ("DATE_RECEIVED"))::TIMESTAMP_NTZ AS "date_received",
       COALESCE(TRY_TO_TIMESTAMP_NTZ("DATE_STARTED", 'MM/DD/YYYY'), TRY_TO_TIMESTAMP_NTZ("DATE_STARTED"))::TIMESTAMP_NTZ AS "date_started",
       COALESCE(TRY_TO_TIMESTAMP_NTZ("DATE_COMPLETED", 'MM/DD/YYYY'), TRY_TO_TIMESTAMP_NTZ("DATE_COMPLETED"))::TIMESTAMP_NTZ AS "date_completed",
