...
WITH methods AS (SELECT test_type FROM OGFS_DEMO.SILVER.silver_lims_annandale_samples
UNION ALL
SELECT test_type FROM OGFS_DEMO.SILVER.silver_lims_houston_samples
UNION ALL
SELECT test_type FROM OGFS_DEMO.SILVER.silver_lims_curitiba_amostras
UNION ALL
SELECT test_type FROM OGFS_DEMO.SILVER.silver_lab_muestras_ba)
