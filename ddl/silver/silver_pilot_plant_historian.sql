...
INSERT INTO silver."silver_pilot_plant_historian" (
              source_row_number, "run_id", "business_line", "unit", "start_timestamp", "end_timestamp", "yield_percent", "throughput_kg_hr", "temperature_c", "pressure_bar", "flow_rate_lmin", "ph_level", "agitation_rpm", "feedstock_material_id", "product_material_id", "batch_operator", "deviation_flag", "deviation_description", "safety_incident_flag", "energy_consumption_kwh", "waste_generated_kg", source_table
            )
  ...
  "row_data"."energyconsumption_kwh" AS "energy_consumption_kwh",
