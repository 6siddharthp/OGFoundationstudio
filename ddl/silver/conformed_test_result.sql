...
INSERT INTO silver.conformed_test_result 
          SELECT 'RES_' || md5('silver_lims_annandale_samples' || ':' || source_row_number) test_result_key,
            ...
            NULL::boolean within_spec, 'silver_lims_annandale_samples' source_system
          FROM silver."silver_lims_annandale_samples" r UNION ALL 
          SELECT 'RES_' || md5('silver_lims_houston_samples' || ':' || source_row_number) test_result_key,
            ...
            (to_jsonb(r)->>'spec_lower_limit')::numeric spec_lower_limit,
            (to_jsonb(r)->>'spec_upper_limit')::numeric spec_upper_limit,
            NULL::boolean within_spec, 'silver_lims_houston_samples' source_system
          FROM silver."silver_lims_houston_samples" r UNION ALL 
          SELECT 'RES_' || md5('silver_lims_curitiba_amostras' || ':' || source_row_number) test_result_key,
            ...
            (to_jsonb(r)->>'spec_lower_limit')::numeric spec_lower_limit,
            (to_jsonb(r)->>'spec_upper_limit')::numeric spec_upper_limit,
            NULL::boolean within_spec, 'silver_lims_curitiba_amostras' source_system
          FROM silver."silver_lims_curitiba_amostras" r;
